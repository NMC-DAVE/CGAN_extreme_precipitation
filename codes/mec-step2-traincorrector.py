...
args = {'gan': 'corrector',
        'generator': 'correctorgen2',
        'discriminator': 'leindisc',
        'noise_shape' : (6, 1, 32, 32),
        'zero_noise': True,
        'seed': 1,
        'save_hparams': {'save_dir': '/LOCALDISK/smlzhuhai_jwma_1/savedmodels/',
                         'run_name': 'correctornc-LT12H-11channels-32pachsize-pad32-newloss-075-lossmax20-tsfss-LT30H', ###changedhere
                         'run_number': 0
                         },
        'input_channels': 11,
        ...
        'data_hparams': {
                        'train_dataset_path': "/LOCALDISK/smlzhuhai_jwma_1/traindata/pachsize_32_11channels-patchsize256-pad32-leadtime-30H/train", ##changedhere
                        'valid_dataset_path': "/LOCALDISK/smlzhuhai_jwma_1/traindata/pachsize_32_11channels-patchsize256-pad32-leadtime-30H/valid", ##changedhere
            'samples_vars':
                {'tp': 1,'lsp':1,'cp':1,'cape':1,'tcwv':1,'hm':1,'v':1,'u':1,'sp':1,'msl':1,'pad_tigge_channel': 1}
                #{'tp': 1,'lsp':1,'cp':1,'cape':1,'tcwv':1,'hm':1,'v':1,'u':1,'sp':1,'msl':1}
        }

        }

json.dump(args, open('/LOCALDISK/smlzhuhai_jwma_1/CGAN/correctornc-LT12H-11channels-32pachsize-pad32-newloss-075-lossmax20-tsfss-LT30H.json','w')) ##changedhere

args = json.load(open('/LOCALDISK/smlzhuhai_jwma_1/CGAN/correctornc-LT12H-11channels-32pachsize-pad32-newloss-075-lossmax20-tsfss-LT30H.json')) ##changedhere
...
from src.models_05 import CheckCorrector
...
ds_train = TiggeMRMSPatchLoadDataset(args.data_hparams['train_dataset_path'],
                                         samples_vars=args.data_hparams['samples_vars'])
ds_valid = TiggeMRMSPatchLoadDataset(args.data_hparams['valid_dataset_path'],
                                         samples_vars=args.data_hparams['samples_vars'])
print(len(ds_valid))
