...
from src.models_05_loglrts import *
...
from src.models_05_loglrts import GANs, gens, discs
...
args = {
        ...
        'save_hparams':{'save_dir': '/LOCALDISK/smlzhuhai_jwma_1/savedmodels/',
                       'run_name': 'correctorgen-nc-LT12H-11channels-32patchsize-pad32-newloss-256batchsize-loss-lhr-ts-weight-100-100-20-20-LT15H/', ###changed here lead time
                       'run_number':0
                      },
        'gen_hparams': {'generator': 'correctorgen2',
                        ...
                        'loss_hparams' : {'gen_loss':{"ens_mean_lr_L1_weighted":100, "ens_mean_L1_weighted": 100,"gen_hr_corrected_ts":20,"gen_lr_corrected_ts":20}} ,
        ...
        'data_hparams': {
                        'train_dataset_path': "/LOCALDISK/smlzhuhai_jwma_1/traindata/pachsize_32_11channels-patchsize256-pad32-leadtime-15H/train",   ##changed here
                        'valid_dataset_path': "/LOCALDISK/smlzhuhai_jwma_1/traindata/pachsize_32_11channels-patchsize256-pad32-leadtime-15H/valid",   ##changed here
            'samples_vars':
                {'tp': 1,'lsp':1,'cp':1,'cape':1,'tcwv':1,'hm':1,'v':1,'u':1,'sp':1,'msl':1,'pad_tigge_channel': 1}
        }
}

json.dump(args, open('/LOCALDISK/smlzhuhai_jwma_1/CGAN/correctorgen-nc-LT12H-11channels-32patchsize-pad32-newloss-256batchsize-loss-lhr-ts-weight-100-100-20-20-LT15H.json', 'w')) ##changed here
...
def train(input_args):
    ...
    ddi_train = pickle.load(open("/LOCALDISK/smlzhuhai_jwma_1/traindata/pachsize_32_11channels-patchsize256-pad32-leadtime-15H/traindataset_det_tp_pad_pw_cape_cp_msl_sp_v_u_gh_vb_ub_lsp.pkl", "rb")) ##changed here
    ...
    if input_args.ckpt_path:
        ...
        model = CorrectorGenerator(**args.gen_hparams)
        save_model = torch.load('/LOCALDISK/smlzhuhai_jwma_1/savedmodels/correctornc-LT12H-11channels-32pachsize-pad32-newloss-075-lossmax20-tsfss-LT15H0/epoch=49-step=10849.ckpt') ##changed here
...
if __name__ == '__main__':
    ...
    input_args.config_path='/LOCALDISK/smlzhuhai_jwma_1/CGAN/correctorgen-nc-LT12H-11channels-32patchsize-pad32-newloss-256batchsize-loss-lhr-ts-weight-100-100-20-20-LT15H.json' ##changed here
    #input_args.ckpt_path = '/LOCALDISK/smlzhuhai_jwma_1/savedmodels/correctorgen-nc-LT12H-11channels-32patchsize-pad32-newloss-256batchsize-loss-lhr-ts-weight-100-100-20-20-LT15H/0/epoch=17-step=15587.ckpt'
